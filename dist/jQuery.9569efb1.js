...
window.jQuery = function (selectorOrArray) {
    ...
    return {
        ...
        children: function children() {
            var array = [];
            this.each(function (node) {
                array.push.apply(array, _toConsumableArray(node.children)); //...把node里面的元素拆开 把第一个元素当作第一个参数
            });
            return jQuery(array);
        },
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + '3251' + '/');
...
//# sourceMappingURL=/jQuery.9569efb1.map